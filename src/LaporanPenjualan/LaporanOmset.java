 ...
 * @author LENOVO
 */
public class LaporanOmset extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int Pilihan = JOptionPane.showConfirmDialog(null, "Tampilkan Laporan Omset", "PERINGATAN !",JOptionPane.YES_OPTION);
        if(Pilihan==JOptionPane.YES_OPTION){
        try {
            File jasper = new File("src/LaporanPenjualan/LaporanOmset.jrxml");
